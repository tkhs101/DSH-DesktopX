...
[![Source](https://img.shields.io/badge/source-285%20%E8%A1%8C%20TypeScript-2ea44f)](src)
...
| 📖 **可审计** | 全部逻辑 5 个文件、约 285 行 TypeScript，几分钟读完 |
...
| 源码可审计性 | ✅ **285 行 TS / 5 个文件**，几分钟读完 | ❌ 13,275 commits + 子模块 + Yarn workspace + 插件 fabric |
...
| `src/main/windows.ts` | 62 | 主窗口 + 启动窗口 + 提示卡片创建、外链拦截、标题锁定 |
